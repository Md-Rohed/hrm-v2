...
import { getAllCompanyDetails } from "@/api/end-points/common";
...
export const useAllCompanyDetails = (useQueryOptions?: Options) => {
    return useQuery({
        queryKey: 'Blogs',
        queryFn: () => getAllCompanyDetails(),
        ...useQueryOptions,
        select: (res) => {
            return res.data;
        },
...
//         mutationFn: (vars) => getAllCompanyDetails(vars),
